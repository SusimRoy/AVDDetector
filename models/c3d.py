...
class C3DVideoEncoder(Module):
    def __init__(self, n_features=(64, 96, 128, 128), v_cla_feature_in: int = 256):
        ...
        # (B, 3, 512, 96, 96) -> (B, 64, 512, 32, 32) (original)
        # (B, 6, 512, 96, 96) -> (B, 64, 512, 32, 32) (modified for 6 channels)
        self.block0 = Sequential(
            Conv3d(6, n_dim0, kernel_size=3, stride=1, padding=1, build_activation=LeakyReLU),
