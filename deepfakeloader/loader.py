...
from .utils import read_json, read_audio, resize_video, iou_with_anchors, \
    read_video_fast, iou_1d, read_video
...
class Metadata:
    ...
    def __init__(self, file: str, original: Optional[str], split: str, fake_segments: List[List[float]], fps: int,
        ...
        audio_model: str, modify_type: str, video_frames: int, audio_frames: int, magnifiedfile: str, audiofile: str, *args, **kwargs
    ):
        self.file = file
        ...
        self.magnifiedfile = magnifiedfile
...
class AVDeepfake1mPlusPlusMagnifiedVideo(Dataset):
